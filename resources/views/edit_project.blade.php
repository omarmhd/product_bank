    ...
    <section class="details-section bg-container edit-product">
            ...
            <div class="post-container">
                ...
                <div class="footer">
                    ...
                    <div class="mt-3 text-center">
                        <a href="{{ route('project.createUpdate', ['id' => $project->id]) }}" class="btn custom-btn-edit">تعديل
                        ...
                        <div class="d-flex justify-content-between visit">
                            ...
                            <div class="rate rate-first" data-toggle="modal" data-target="#rate">
                                <svg xmlns="http://www.w3.org/2000/svg" width="53.034" height="61.224"
                                    ...
                                    <g id="Group_240" data-name="Group 240" transform="translate(-651.518 -757.444)">
                        ...
                        <div class="col-11 col-md-9">
                            <div class="hor-card clone d-none">
                                <div class="main-custom-input">
                                    ...
                                    <input type="text" disabled name="factor[]" class="title-text"
                                        value="مبلغ العوائد اكثر من 100000 الف ريال">
                                    <input type="text" disabled name="target_number[]" class="goal"
                                        value="100000">
                                ...
                                <div class="info">
                                    ...
                                    <div class="actions">
                                        <span class="remove">
                                            <svg id="outline-delete_forever-24px" xmlns="http://www.w3.org/2000/svg"
                                                width="24" height="24" viewBox="0 0 24 24">
                                                <g id="Bounding_Boxes">
                                                    <path id="Path_2320" data-name="Path 2320" d="M0,0H24V24H0Z"
                                                        fill="none" />
                                                </g>
                                                <g id="Outline">
                                                    <g id="Group_46" data-name="Group 46">
                                                        <path id="Path_2321" data-name="Path 2321"
                                                            d="M14.12,10.47,12,12.59,9.87,10.47,8.46,11.88,10.59,14,8.47,16.12l1.41,1.41L12,15.41l2.12,2.12,1.41-1.41L13.41,14l2.12-2.12Z"
                                                            fill="#1e1656" />
                                                        <path id="Path_2322" data-name="Path 2322"
                                                            d="M15.5,4l-1-1h-5l-1,1H5V6H19V4Z" fill="#1e1656" />
                                                        <path id="Path_2323" data-name="Path 2323"
                                                            d="M6,19a2.006,2.006,0,0,0,2,2h8a2.006,2.006,0,0,0,2-2V7H6ZM8,9h8V19H8Z"
                                                            fill="#1e1656" />
                                                    </g>
                                                </g>
                                            </svg>
                                        ...
                                        <span class="edit">
                                            <svg id="outline-edit-24px" xmlns="http://www.w3.org/2000/svg" width="24"
                                                height="24" viewBox="0 0 24 24">
                                                <g id="Bounding_Boxes">
                                                    <path id="Path_3051" data-name="Path 3051" d="M0,0H24V24H0Z"
                                                        fill="none" />
                                                </g>
                                                <g id="Outline_1_">
                                                    <path id="XMLID_37_"
                                ...
                                @foreach ($project->targets as $target)
                                    <div class="hor-card">
                                        ...
                                        <div class="main-custom-input d-none">
                                            ...
                                            <input type="text" name="factor[]" class="title-text"
                                                value="{{ $target->factor }}">
                                            <input type="text" name="target_number[]" class="goal"
                                                value="{{ $target->target_number }}">
                                            <input type="text" name="result[]" class="total"
                                                value="{{ $target->result }}">
                                        ...
                                        <div class="info">
                                            ...
                                            <span class="percentage">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"
                                                    ...
                                                    <g id="circles_group" data-name="Group 239"
                                                        ...
                                                        <path id="circle_3" data-name="Path 68"
                                                            d="M651.723,206.195a2.417,2.417,0,1,1-3.3-.895A2.417,2.417,0,0,1,651.723,206.195Z"
                                                            transform="translate(-3.793 469.101)" class="circle-svg">
                                                        </path>
                                                        <path id="circle_4" data-name="Path 70"
                                                            d="M646.674,209.257a2.4,2.4,0,1,1-1.7-.707A2.417,2.417,0,0,1,646.674,209.257Z"
                                                            transform="translate(-5.353 470.298)" class="circle-svg">
                                                        </path>
                                                        <path id="circle_5" data-name="Path 72"
                                                            d="M642.612,213.533a2.417,2.417,0,1,1-1.839-.248,2.417,2.417,0,0,1,1.839.248Z"
                                                            transform="translate(-6.552 471.857)" class="circle-svg">
                                                        </path>
                                                        <path id="circle_6" data-name="Path 74"
                                                            d="M639.756,218.709a2.417,2.417,0,1,1-2.937,1.749A2.417,2.417,0,0,1,639.756,218.709Z"
                                                            transform="translate(-7.301 473.677)" class="circle-svg">
                                                        </path>
                                                        <ellipse id="circle_7" data-name="Ellipse 9" cx="2.417" cy="2.417"
                                                            rx="2.417" ry="2.417" transform="translate(628.41 700.077)"
                                                            class="circle-svg"></ellipse>
                                                        <path id="circle_8" data-name="Path 77"
                                                            d="M638.53,230.351a2.417,2.417,0,1,1-1.469,1.127,2.417,2.417,0,0,1,1.469-1.127Z"
                                                            transform="translate(-7.303 477.577)" class="circle-svg">
                                                        </path>
                                                        <path id="circle_9" data-name="Path 79"
                                                            d="M640.2,236.021a2.4,2.4,0,1,1-1.136,1.462A2.417,2.417,0,0,1,640.2,236.021Z"
                                                            transform="translate(-6.552 479.397)" class="circle-svg">
                                                        </path>
                                                        <path id="circle_10" data-name="Path 81"
                                                            d="M643.243,241.032a2.417,2.417,0,1,1,.094,3.31,2.416,2.416,0,0,1-.094-3.31Z"
                                                            transform="translate(-5.327 480.982)" class="circle-svg">
                                                        </path>
                                                        <path id="Path_83" data-name="Path 83"
                                                            d="M647.53,245.135a2.417,2.417,0,1,1,.894,3.3A2.417,2.417,0,0,1,647.53,245.135Z"
                                                            transform="translate(-3.793 482.152)" class="circle-svg">
                                                        </path>
                                                        <path id="Path_85" data-name="Path 85"
                                                            d="M652.722,247.959a2.4,2.4,0,1,1,.235,1.839,2.417,2.417,0,0,1-.235-1.839Z"
                                                            transform="translate(-1.975 482.907)" class="circle-svg">
                                                        </path>
                                                        <path id="Path_65" data-name="Path 65"
                                                            d="M663.283,249.343a2.417,2.417,0,1,1-2.417-2.4,2.417,2.417,0,0,1,2.417,2.4Z"
                                                            transform="translate(-0.026 483.164)" class="circle-svg">
                                                        </path>

                                                        <path id="Path_67" data-name="Path 67"
                                                            d="M669.023,247.96a2.417,2.417,0,1,1-1.128-1.469A2.417,2.417,0,0,1,669.023,247.96Z"
                                                            transform="translate(1.925 482.905)" class="circle-svg">
                                                        </path>

                                                        <path id="Path_69" data-name="Path 69"
                                                            d="M674.2,245.132a2.417,2.417,0,1,1-3.3-.881,2.417,2.417,0,0,1,3.3.881Z"
                                                            transform="translate(3.743 482.155)" class="circle-svg">
                                                        </path>

                                                        <path id="Path_71" data-name="Path 71"
                                                            d="M678.476,241.059a2.4,2.4,0,1,1-1.709-.714A2.4,2.4,0,0,1,678.476,241.059Z"
                                                            transform="translate(5.303 480.954)" class="circle-svg">
                                                        </path>

                                                        <path id="Path_73" data-name="Path 73"
                                                            d="M681.55,236.021a2.417,2.417,0,1,1-3.3.881,2.417,2.417,0,0,1,3.3-.881Z"
                                                            transform="translate(6.502 479.396)" class="circle-svg">
                                                        </path>

                                                        <path id="Path_75" data-name="Path 75"
                                                            d="M683.215,230.35a2.417,2.417,0,1,1-2.964,1.709,2.417,2.417,0,0,1,2.964-1.709Z"
                                                            transform="translate(7.253 477.577)" class="circle-svg">
                                                        </path>

                                                        <path id="Path_76" data-name="Path 76"
                                                            d="M683.357,224.45a2.417,2.417,0,1,1-2.417,2.417,2.417,2.417,0,0,1,2.417-2.417Z"
                                                            transform="translate(7.512 475.627)" class="circle-svg">
                                                        </path>

                                                        <path id="Path_78" data-name="Path 78"
                                                            d="M681.959,218.711a2.417,2.417,0,1,1-1.709,2.964,2.417,2.417,0,0,1,1.709-2.964Z"
                                                            transform="translate(7.254 473.675)" class="circle-svg">
                                                        </path>

                                                        <path id="Path_80" data-name="Path 80"
                                                            d="M679.132,213.532a2.417,2.417,0,1,1-.881,3.3,2.417,2.417,0,0,1,.881-3.3Z"
                                                            transform="translate(6.502 471.858)" class="circle-svg">
                                                        </path>

                                                        <path id="Path_82" data-name="Path 82"
                                                            d="M675.056,209.256a2.417,2.417,0,1,1,0,3.418A2.43,2.43,0,0,1,675.056,209.256Z"
                                                            transform="translate(5.305 470.299)" class="circle-svg">
                                                        </path>

                                                        <path id="Path_84" data-name="Path 84"
                                                            d="M670.022,206.194a2.4,2.4,0,1,1-.247,1.833A2.417,2.417,0,0,1,670.022,206.194Z"
                                                            transform="translate(3.743 469.102)" class="circle-svg">
                                                        </path>

                                                        <ellipse id="Ellipse_10" data-name="Ellipse 10" cx="2.417"
                                                            cy="2.417" rx="2.417" ry="2.417"
                                                            transform="translate(665.472 674.822) rotate(-67.42)"
                                                            class="circle-svg"></ellipse>
                                                    </g>
                                                    <text class="text-svg" x="47" y="37">
                                            ...
                                            <div class="actions">
                                                ...
                                                <span class="edit">
                                                    <svg id="outline-edit-24px" xmlns="http://www.w3.org/2000/svg"
                                                        width="24" height="24" viewBox="0 0 24 24">
                                                        <g id="Bounding_Boxes">
                                                            <path id="Path_3051" data-name="Path 3051" d="M0,0H24V24H0Z"
                                                                fill="none" />
                            ...
                            <div class="mt-3 mb-3 mr-5 pr-3 text-right">
                                <button type="submit" class="btn custom-btn-edit btn-edit-target"
                                    data-id="{{ $project->id }}">حفظ</button>
                            </div>
                        </div>
                    </div>
                </form>
                    ...
                    @foreach ($project->attachments as $attachment)
                        ...
                        <div class="col-11 col-md-8">
                            <div class="hor-card">
                                ...
                                <div class="info">
                                    <a href="{{ asset('files') }}/{{ $attachment->attachment }}" class="btn btn-custom"
                                        download>تحميل</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="border-bottom-c">
            <div class="form-status">
                <form action="{{ route('status.update', ['id' => $project->id]) }}" method="post" id="form-edit-status"
                    class="form-edit-status" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="main-custom-input mt-2">
                                <input name="reason_status" type="text" placeholder="توضيح السبب"
                                    value="{{ $project->reason_status }}">
                            </div>
                            <div class="main-custom-input mt-2 ">
                                <textarea name="notes" id="" cols="37" rows="5"
                                    placeholder="ملاحظات">{{ $project->notes }}</textarea>
                            ...
                            <div class="upload">
                                ...
                                <div class="main-custom-input upload-input">
                                    ...
                                    <button type="button" class="btn custom-btn-edit upload-file-btn" name="upload"
                                        value="upload">
                        ...
                        <div class="col-8">
                            <div class="mt-3 mb-3 text-right">
                                <input type="submit" class="btn custom-btn-edit btn-edit-status" value="حفظ" name="save"
                                    data-id="{{ $project->id }}">
                            </div>
                        </div>
                    </div>
