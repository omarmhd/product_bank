...
{{--                                </span>--}}
                        ...
                        <div class="d-flex justify-content-between flex-wrap mx-auto mb-3 col-lg-6">
                            ...
                            <div class="reset-padding-col">
                                <a href="#"  data-toggle="modal" data-target="#register" class="btn-register">
                                     تسجيل
                                </a>
                            </div>
                        </div>
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h3>التسجيل كمدير مشروع </h3>
                            <p> قم بإدخال كافة بياناتك بشكل صحيح</p>
                        </div>
                        <div class="col-12">
                            @if ($errors->any())
                                <div class="alert alert-danger">
                        ...
                        <div class="d-flex justify-content-between flex-wrap mx-auto mb-3 col-lg-6">
                            ...
                            <div class="reset-padding-col">
                                <a href="#"  data-toggle="modal" data-target="#login" class="btn-login">
